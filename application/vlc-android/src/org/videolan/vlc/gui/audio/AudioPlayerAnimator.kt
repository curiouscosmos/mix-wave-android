...
internal class AudioPlayerAnimator : IAudioPlayerAnimator, LifecycleObserver {
    ...
    private fun initConstraintSets() {
        ...
        if (showTabletControls()) {
            ...
            hidePlaylistLandscapeConstraint.createVerticalChain(R.id.header, ConstraintSet.BOTTOM, R.id.time, ConstraintSet.TOP, arrayOf(R.id.cover_media_switcher, R.id.track_info_container).toIntArray(), null, ConstraintSet.CHAIN_PACKED)
        }
    }
